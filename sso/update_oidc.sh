...
wget -O agents.json "https://infra-api.imio.be/sso/agents/$ENVIRONMENT" && chmod 777 agents.json
wget -O usagers.json "https://infra-api.imio.be/sso/usagers/$ENVIRONMENT" && chmod 777 usagers.json
