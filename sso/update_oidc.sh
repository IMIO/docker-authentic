...
wget -O agents.json "http://infra-api.imio.be/sso/plone/agents/$ENVIRONMENT" && chmod 777 agents.json
wget -O usagers.json "http://infra-api.imio.be/sso/plone/usagers/$ENVIRONMENT" && chmod 777 usagers.json
